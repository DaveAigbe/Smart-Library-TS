  ...
  return (
    <div
      ...
      className={
        ...
        "before:absolute before:border-y-8 before:border-r-8 before:border-solid before:border-y-transparent before:border-l-transparent before:border-r-main-hlt " +
